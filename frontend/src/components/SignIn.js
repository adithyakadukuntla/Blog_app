...
const {currentUser,errorStatus,errorMessage,loginStatus}=useSelector((state)=>state.userLogin);
...
useEffect(() => {
  ...
  return (
          ...
          <label >Password</label>
            <input
             ...
             {errors.password?.type === "maxLength" && (
               <p className="text-danger lead fs-5">Max length of password is 12</p>
             )}
             </div>
    ...
    <div className="form-check ">
    <input type="checkbox" name="password-toggle" id="password-toggle" />
               <label htmlFor="user" className="form-check-label ">
                 Show Password
               </label>
             </div>
            ...
            <p>New User?
             ...
             <Link  to='mailto:adhichiru634@gmail.com?subject=Hello&body=Write your message here'>Help?</Link>
            </div>
            
             <div className='d-flex justify-content-end' >
             <button class="button-48" type='submit'><span class="text">Login</span></button>
